...
export const metadata: Metadata = {
  ...
  description: "Sheikh Mujtaba builds secure AI agents, ERPNext automation, and digital FTE solutions. Cybersecurity & full-stack development specialist. Expert in AI agents, RAG pipelines, LLM integration, and business automation.",
  keywords: [
    "Sheikh Mujtaba",
    "cybersheikh",
    "AI agents",
  ...
  generator: "Next.js",
  applicationName: "Sheikh Mujtaba Portfolio",
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: siteUrl,
    siteName: "Sheikh Mujtaba - AI Developer & Security Engineer",
    title: "Sheikh Mujtaba | AI Developer, Security Engineer & ERPNext Expert",
    description: "Building secure AI systems, ERPNext automation solutions, and digital transformation. Specializing in AI agents, RAG pipelines, and enterprise automation.",
    images: [
      {
  ...
  twitter: {
    ...
    description: "Building secure AI agents and ERPNext automation solutions",
        ...
        <main>
          <section className={`${styles.hero} px-1`} data-hero>
            <div className={styles.cta}>
              <div className="flex flex-col gap-1 w-full min-w-0" data-hero-copy>
              ...
              <div data-hero-visual>
                ...
                >
                  ...
                  />
                  <div className={styles.portraitBadge} data-hero-badge>
          ...
          >
            <div className={styles.aboutGrid}>
              <div className={styles.aboutVisualSlot} data-about-visual-slot>
                <div className={styles.aboutPortraitTarget} data-about-portrait-target />
              </div>
              <div className={styles.aboutContent}>
                <p className={styles.sectionKicker}>Who I Am</p>
            ...
            <div className={styles.aboutFullContent}>
              <h3 className="text-xl font-semibold mt-8 mb-3 text-cyan-400">Core Expertise</h3>
              <ul className={`${styles.aboutList} mb-6`}>
          ...
          <section
            ...
            data-reveal
          >
            <p className={styles.sectionKicker}>Career Journey</p>
            <h2>Experience</h2>
            <ul data-experience-list>
              <li data-experience-item data-direction="left">
              ...
              <li data-experience-item data-direction="right">
          ...
          <section
            ...
            data-reveal
          >
            <p className={styles.sectionKicker}>Latest Writing</p>
            <h2>My Blog</h2>
            <ul>
              {blogPosts.map((post, i) => (
                <li key={i} data-reveal-item>
          ...
          <FeaturedShowcase
            projects={projectsList.filter((project) => project.featured)}
          />
          <section className={`${styles.projectContainer} pb-20`} id="projects">
            <div className={styles.projectTitleContainer} data-reveal>
              <p className={styles.sectionKicker}>Portfolio</p>
              <h2>My Projects</h2>
              <p className={styles.projectCount}>
                {projectsList.length} shipped builds across AI, full-stack &amp; security
              </p>
            </div>
          ...
          {/* Quick Links Section */}
          <section className={styles.quickLinks} data-reveal>
